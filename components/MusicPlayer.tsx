                ...
                {isTrackListOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            transition={{ duration: 0.3 }}
                            className="w-screen h-screen md:w-full md:h-full md:max-w-6xl md:max-h-[90vh] bg-gradient-to-br from-zinc-950 via-zinc-900 to-black rounded-xl shadow-2xl overflow-hidden flex flex-col"
                        >
                            ...
                            <div className="relative h-72 sm:h-80 md:h-96 bg-gradient-to-b from-zinc-800 to-zinc-900 p-5 sm:p-7 flex flex-row flex-wrap items-center justify-start gap-3 sm:gap-5 md:gap-8">
                                ...
                                <a
                                    ...
                                    className="absolute top-10 sm:top-5 right-3 sm:right-4 z-10 p-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors"
                                >
                                    <img
                                ...
                                <div className="relative z-10 flex-1 pb-2 text-left md:pl-2">
                                    <p className="text-xs sm:text-sm font-semibold text-zinc-300 uppercase tracking-widest mb-1">Now Playing</p>
                                    <h1 className="text-xl sm:text-2xl md:text-5xl font-bold text-white mb-2 leading-tight">{currentTrack.title}</h1>
                                    {currentTrack.artist && (
                                        <p className="text-sm sm:text-base text-zinc-300 mb-2">{currentTrack.artist}</p>
                                    )}
                                    <p className="text-xs sm:text-sm text-zinc-400">{tracks.length} songs in playlist</p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div className="space-y-1">
                                    {tracks.map((track, index) => (
                                        ...
                                        >
                                            <div className={`col-span-1 font-medium ${currentTrackIndex === index ? 'text-green-400' : 'text-zinc-400'}`}>
                                                {index + 1}
                                            </div>
                                            <div className={`col-span-6 text-left font-medium ${currentTrackIndex === index ? 'text-white' : 'text-zinc-100'} group-hover:text-white truncate`}>
                                                {track.title}
                                            </div>
                                            <div className={`col-span-5 text-left flex items-center justify-between ${currentTrackIndex === index ? 'text-green-300' : 'text-zinc-400'}`}>
